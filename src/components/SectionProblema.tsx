    ...
    <section className="bg-off-white py-section-mobile md:py-section-desktop">
      <div ref={sectionRef} className="mx-auto px-5 md:px-10" style={{ maxWidth: "860px" }}>
        ...
        >
          {/* Intro */}
          <p {...fade(0)} >
            <span className="block text-center font-body text-body-mobile md:text-body text-texto-secundario mb-4">
          ...
          {/* Headline */}
          <div {...fade(200)}>
            <h2 className="text-center font-headline font-bold text-[28px] md:text-[40px] leading-tight text-vermelho-terroso mb-8">
              O PROBLEMA NÃO É O SEU CAVALO.
            </h2>
          </div>

          {/* Emotional text block 1 */}
          <div {...fade(400)}>
            <div className="max-w-text mx-auto space-y-5 text-center font-body text-body-mobile md:text-body text-texto-corpo mb-10">
              ...
              <div className="hidden md:flex items-center justify-center gap-2">
                {cycleSteps.map((step, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <div
                      className="bg-roxo-medio text-white font-body text-[13px] font-medium px-4 py-3 rounded-lg text-center min-w-[130px] transition-all duration-500 ease-out"
                      style={{
                    ...
                    {i < cycleSteps.length - 1 && (
                      <ArrowRight size={16} className="text-dourado-claro flex-shrink-0" />
                    )}
                  </div>
                ))}
                <div
              ...
              <div className="flex md:hidden flex-col items-center gap-3">
                {cycleSteps.map((step, i) => (
                  <div key={i} className="flex flex-col items-center gap-3">
                    <div
                      className="bg-roxo-medio text-white font-body text-[13px] font-medium px-5 py-3 rounded-lg text-center w-full max-w-[240px] transition-all duration-500 ease-out"
                      style={{
                        transitionDelay: `${700 + i * 120}ms`,
                        opacity: visible ? 1 : 0,
                    ...
                    {i < cycleSteps.length - 1 && (
                      <ArrowRight size={16} className="text-dourado-claro rotate-90" />
                    )}
                  </div>
                ))}
                <div
          ...
          <div {...fade(1100)}>
            <h2
              className="text-center font-headline font-bold text-[40px] md:text-[56px] text-dourado mt-8 mb-4"
              style={{
                textShadow: visible ? "0 0 40px hsl(var(--dourado) / 0.4), 0 0 80px hsl(var(--dourado) / 0.15)" : "none",
          ...
          {/* Scientific text */}
          <div {...fade(1200)}>
            <div className="max-w-text mx-auto space-y-5 text-center font-body text-body-mobile md:text-body text-texto-corpo">
              <p>
              ...
              <p>
                Eu sou a única profissional no Brasil que criou um método de doma
              ...
              <p>
                Depois de mais de <span className="font-bold text-roxo-claro">600 cavalos</span> trabalhados — incluindo casos que
          ...
          {/* Closing */}
          <div {...fade(1400)}>
            <p className="text-center font-body font-bold text-[18px] md:text-[20px] text-roxo-profundo mt-8">
