  ...
  return (
    <section className="bg-neutral-50 py-section-mobile md:py-section-desktop">
      <div className="mx-auto px-5 md:px-10" style={{ maxWidth: 860 }}>
        <div
          className="bg-white rounded-[12px] p-6 md:p-12"
          style={{ boxShadow: "0 2px 8px rgba(42,21,48,0.06)", border: "1px solid hsl(var(--neutral-200))" }}
        >
          <div ref={headline.ref}>
            ...
            <h2
              className="text-center font-headline font-bold text-[28px] md:text-[40px] leading-tight text-coral-dark mb-6 transition-all duration-[800ms] ease-out"
              style={{
