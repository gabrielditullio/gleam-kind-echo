        ...
        >
          <div className="flex flex-col md:flex-row gap-8 md:gap-10">
            ...
            <div className="w-full md:w-[60%]">
              <p
                className="font-body text-[12px] text-neutral-400 uppercase mb-2 tracking-[0.1em] font-semibold transition-all duration-500 ease-out"
              ...
              <div
                className="h-[3px] bg-sand-default mt-2 mb-4 transition-all duration-500 ease-out"
